...
#'
#' @description
#' Construct an `acc`, `gyro`, or `mag` vector from a list of burst
...
#' (acceleration, angular velocity, magnetic field strength).
#'
...
#' )
#'
#' # The same API for gyroscope and magnetometer data:
#' gyro(

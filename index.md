...
![Sampling effort for nine albatross tracks over a two-minute window.
Each track is drawn as its own row, with shaded bins marking the times
at which acceleration samples were
recorded.](reference/figures/README-sampling-effort-1.png)
